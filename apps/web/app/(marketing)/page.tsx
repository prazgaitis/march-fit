      ...
      <section className="relative flex min-h-screen flex-col overflow-hidden px-6 py-10 sm:px-12 lg:px-24">
        ...
        <div className="z-10 mt-auto flex flex-col gap-12 pb-24 pt-16 sm:pt-24">
          ...
          <div className="max-w-xl space-y-4 text-lg text-zinc-300">
            <p>
              Where competition meets community. Our challenges cut through the noise with data-backed programming, bold
              community energy, and results you can feel.
            </p>
            <p>
              We champion the athletes, the creatives, and the relentless. Step in ready to move, leave louder than you
              arrived.
            </p>
          </div>
        ...
        <footer className="z-10 mt-auto flex flex-wrap items-center justify-between gap-4 border-t border-white/10 py-6 text-xs uppercase tracking-[0.35em] text-zinc-500">
          <span>Pulse-driven training</span>
